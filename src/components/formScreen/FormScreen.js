...
const FormScreen = () => {
  ...
  const reciver = "idit003@gmail.com";
  ...
  return (
    <div className={styles.formScreenContainer} id="טופס">
      <div className={styles.titleContainer}>
        <div className={styles.title}>כולם התחילו כאן</div>
      </div>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            <textarea
              ...
              placeholder="תנו לי קצת רקע על העסק"
              disabled={isSubmitting || submitted}
              ref={reasonRef}
            />
          ...
          <button 
            ...
            disabled={isSubmitting || submitted}
          >
            {isSubmitting ? 'שולח...' : submitted ? 'נשלח בהצלחה!' : 'עידית, בואי נדבר!'}
          </button>
        </form>
      </div>
    </div>
