...
import negaim2 from "../../images/עידית בזק הסרת נגעים 2.png"; // ודא שקיים, אחרת אמור לי
...
const MyServices = () => {
  ...
  const services = [
   {
      ...
      suitableFor: [
        "למי שסובל מכתמי שמש ופיגמנטציה",
        "למי שיש לו צבע עור לא אחיד",
        "למי שרוצה עור זוהר ובהיר יותר",
        "למי שמחפש פתרון לכתמי גיל"
      ],
      problemSolved: [
        "מטפל בהיפרפיגמנטציה ומבהיר כתמי עור",
        "משפר מרקם העור ויוצר גוון אחיד",
        "מחזיר ביטחון עצמי ותחושת נוחות עם המראה"
      ],
      duration: "45-60 דקות",
      image: behara1,
    ...
    },
    {
      ...
      suitableFor: [
        "למי שסובל מאקנה פעילה או צלקות אקנה",
        "למי שיש לו עור שמן ונקבוביות סתומות",
        "למי שמתמודד עם דלקות ואדמומיות",
        "למי שרוצה למנוע הופעת אקנה עתידית"
      ],
      problemSolved: [
        "מטפל באקנה פעילה ומקטין דלקות",
        "מנקה נקבוביות ומווסת הפרשת שמן",
        "מחזיר ביטחון עצמי ונוחות בחברה"
      ],
      duration: "60-75 דקות",
      image: acne1,
    ...
    },
    {
      ...
      suitableFor: [
        "למי שיש לו יבלות או כתמי זקנה",
        "למי שרוצה להסיר נגעי עור קטנים",
        "למי שמפריע לו נגע מבחינה אסתטית",
        "למי שמחפש פתרון בטוח וללא צלקות"
      ],
      problemSolved: [
        "מסיר נגעי עור בבטחה וללא צלקות",
        "משפר את המראה הכללי של העור",
        "מעניק תחושת נקיון ושלמות אסתטית"
      ],
      duration: "30-45 דקות",
      image: negaim1,
    ...
    },
    {
      ...
      suitableFor: [
        "למי שיש לו גבות דלילות או חסרות",
        "למי שרוצה צורת גבות מעוצבת ומושלמת",
        "למי שמתעייף מהתאמת גבות יומית",
        "למי שרוצה מראה טבעי וזמין תמיד"
      ],
      problemSolved: [
        "יוצר מראה גבות מושלם וטבעי לתקופה ארוכה",
        "חוסך זמן יומי ומעניק צורה מדויקת",
        "מחזיר ביטחון עצמי ותחושת מושלמות"
      ],
    ...
    },
 {
  ...
  suitableFor: [
    "למי שרואה סימני הזדקנות ראשונים",
    "למי שיש לו קמטים או עור רפוי",
    "למי שרוצה למנוע הזדקנות מוקדמת",
    "למי שמחפש עור צעיר ומתוח יותר"
  ],
  problemSolved: [
    "מחדש את העור ומקטין קמטים וקווי הבעה",
    "משפר גמישות ומתיחות העור",
    "מחזיר תחושת צעירות וביטחון עצמי"
  ],
  duration: "75-90 דקות",
  image: anti1,
  galleryImages: [anti1]
