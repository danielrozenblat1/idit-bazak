...
const stepsData = [

  {
    ...
    description: "את יודעת לטפל, את משקיעה, את רוצה – אבל השקט בטלפון מבלבל. זה לא כי את לא מספיק מוכשרת, אלא כי אף אחד לא לימד אותך איך לגרום להן לבחור דווקא בך."
  },
    {
    id: 4,
    icon: business,
    ...
    description: "זה להבין שיש שעות עבודה, תמחור, גבולות, תכנון. שהדרך להצליח לא תלויה רק בכמה את מקצועית – אלא בניהול נכון של העסק - שיווק, מכירות, שימור לקוחות.."
  },
  {
    id: 3,
    icon: price,
    playerRef: playerRef3,
    title: "לדעת לתמחר נכון ולרהט את הקליניקה במוצרים הנכונים",
    description: "לדעת לתמחר את השירותים שאת נותנת בצורה נכונה , לבנות מחירון,להביא מוצרים שהם באמת טובים ולא את העגלה הבסיסית שכולם קונים ונתקעים איתה במשך חודשים ארוכים"
  },
